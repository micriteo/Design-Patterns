    ...
    public sealed partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            var items = new List<Item>
            {
                ...
                new Item(new List<string> {"Drama"}, "Kid who is really good at shogi, questions life", "3-gatsu no Lion", "Anime", @"C:\Users\dimit\Source\Repos\micriteo\Design-Patterns\MyWatchList\MyWatchList\testImages\SangatsuNoLion.jpg"),
                ...
                new Item(new List<string> {"Action", "School" }, "Trying to take over the world with mechs and mind control", "Code Geass: Hangyaku no Lelouch", "Anime", @"C:\Users\dimit\Source\Repos\micriteo\Design-Patterns\MyWatchList\MyWatchList\testImages\CodeGeassHangyakuNoLelouch.jpg"),
                ...
                new Item(new List<string> {"Action","Historical", "Drama", "Psychological"}, "Japanese man chases down crazy german orphan to prove his innocence", "Monster", "Anime", @"C:\Users\dimit\Source\Repos\micriteo\Design-Patterns\MyWatchList\MyWatchList\testImages\Monster.jpg"),
                ...
                new Item(new List<string> {"Action", "Comedy", "Food"}, "Teen attempts to pass culinary school", "Shokugeki no Souma", "Anime", @"C:\Users\dimit\Source\Repos\micriteo\Design-Patterns\MyWatchList\MyWatchList\testImages\ShokugekiNoSoma.jpg"),
                ...
                new Item(new List<string> {"Action", "Fantasy" }, "Children wander into closet world", "The Chronicles of Narnia", "Movie", @"C:\Users\dimit\Source\Repos\micriteo\Design-Patterns\MyWatchList\MyWatchList\testImages\Narnia.png"),
                ...
                new Item(new List<string> {"History", "Drama" }, "He became death, destroyer of worlds", "Oppenheimer", "Movie", @"C:\Users\dimit\Source\Repos\micriteo\Design-Patterns\MyWatchList\MyWatchList\testImages\Oppenheimer.png"),
